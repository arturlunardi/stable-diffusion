...
def generate(
    ...
    with torch.no_grad():
        ...
        if do_cfg:
            ...
            # [b_size, seq_len] -> [b_size, seq_len, dim] = [1, 77, 768]
            context = clip(tokens)
        ...
        if input_image:
            ...
            # [height, width, channel] -> [b_size, height, width, channel]
            input_image_tensor = input_image_tensor.unsqueeze(0)
            # [b_size, height, width, channel] -> [b_size, channel, height, width]
            input_image_tensor = input_image_tensor.permute(0, 3, 1, 2)

            encoder_noise = torch.rand(
            ...
            # if we're doing text-to-image, start with random noise N(0, I)
        ...
        for i, timestep in timesteps:
            ...
            # [b_size, 4, latents_height, latents_width]
            model_input = latents

            if do_cfg:
                # [b_size, 4, latents_height, latents_width] -> [2 * b_size, 4, latents, latents_height, latents_width]
        ...
        # [b_size, channel, height, width] -> [b_size, height, width, channel]
