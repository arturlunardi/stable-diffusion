...
class DDPMSampler:
    ...
    def step(self, timestep: int, latents: torch.Tensor, model_output: torch.Tensor):
        ...
        pred_original_sample_coefficient = (
        ...
        pred_prev_sample = (
            pred_original_sample_coefficient * pred_original_sample
    ...
    def add_noise(
        self, original_samples: torch.FloatTensor, timestep: torch.IntTensor
    ) -> torch.FloatTensor:
